...
| ⭐ | **Jhon Christian Quispe Anagua** | **Ingeniería de Sistemas** | **`LEAD DEVELOPER`** |
| 👤 | Luis Fernando Quispe Sullca | Ingeniería en Ciencias de la Computación | Colaborador |

</div>

> 💡 **Nota:** Todos los integrantes contribuyeron por igual al desarrollo del laboratorio. El rol de *Lead Developer* en esta variante es asignado a **Jhon Christian Quispe Anagua** como representante del flujo de trabajo colaborativo en Git.
