...
| ⭐ | **Calatayud Mamani Alex Josue** | **Ingeniería de Sistemas** | **`LEAD DEVELOPER`** |
...
> 💡 **Nota:** Todos los integrantes contribuyeron por igual al desarrollo del laboratorio. El rol de *Lead Developer* en esta variante es asignado a **Alex Josue Calatayud Mamani** como representante del flujo de trabajo colaborativo en Git.
